...
def main():
    ...
    parser.add_argument(
        "--virials_key", type=str, help="Virials key", default="virials"
    )
    parser.add_argument(
        "--dipole_key", type=str, help="Dipole key", default="dipoles"
    )
    parser.add_argument(
        "--charges_key", type=str, help="Charges key", default="charges"
    )
    parser.add_argument(
